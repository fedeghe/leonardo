window.onload = function () {
	...
	var target = document.getElementById('trg'),
		...
		circle2 = L.circle(
			w20 * 10, h20 * 11,
			0.9 * Math.min(width, height)/2
		).attrs({fill : '#F59908'}),
		circle3 = L.circle(
			w20 * 10, h20 * 12,
			0.8 * Math.min(width, height)/2
		).attrs({fill : '#F9F90F'}),
		circle4 = L.circle(
			w20 * 10, h20 * 13,
			0.7 * Math.min(width, height)/2
		).attrs({fill : '#3BC439'}),
		circle5 = L.circle(
			w20 * 10, h20 * 14,
			0.6 * Math.min(width, height)/2
		).attrs({fill : '#495BEB'}),
		circle6 = L.circle(
			w20 * 10, h20 * 15,
			0.5 * Math.min(width, height)/2
		).attrs({fill : '#AB47DF'}),
		circle7 = L.circle(
			w20 * 10, h20 * 16,
			0.4 * Math.min(width, height)/2
		).attrs({fill : '#E475ED'}),
		circle8 = L.circle(
			w20 * 10, h20 * 17,
			0.3 * Math.min(width, height)/2
		).attrs({fill : 'pink'}),
		circle9 = L.circle(
			w20 * 10, h20 * 18,
			0.2 * Math.min(width, height)/2
		).attrs({fill : 'white'});
