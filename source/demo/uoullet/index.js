window.onload = function () {
    ...
    function render() {
        ...
        var target = document.getElementById('trg'),
            ...
            // grid = Leo.group(
            //   Leo.line(0,10,1100,10),
            //   Leo.line(0,30,1100,30),
            //   Leo.line(0,100,1100,100),
            //   Leo.line(0,120,1100,120),
            ...
            u1 = Leo.path(
                Leo.pathBuild
                    ...
                    // .A(gap*wGapMul, gap*hGapMul, 0, 0, 0, gap, gap*hGapMul)
                    // .Z()
                    ).setAttributes({...fillStyle, fill:'#55000077'}),
            o = Leo.path(
                Leo.pathBuild
                    .M(gap, gap*hGapMul)
                    .L(gap, bxHeight - gap*hGapMul)
            ...
            ).move(bxWidth, 0).setAttributes(({...fillStyle, fill:'#00550077'})),
            l1 = Leo.path(
                Leo.pathBuild
                    .M(gap, gap*hGapMul)
                    .L(gap, bxHeight - gap*hGapMul)
                    ...
                    // .L(bxWidth - gap, gap*hGapMul)
                    // .A(gap*wGapMul, gap*hGapMul, 0, 0, 0, bxWidth - gap*wGapMul, gap)
            ).move(bxWidth*3, 0).setAttributes(({...fillStyle, fill:'#00005577'})),
            ...
            e = Leo.path(
                Leo.pathBuild
                    ...
                    .L(wGapMul*gap + gap, bxHeight - hGapMul*gap)
                    .A(gap, gap, 0, 0, 1, wGapMul*gap + gap - gap, bxHeight - hGapMul*gap - gap)
                    .L(wGapMul*gap, bxHeight/2 + gap)
                    .L(bxWidth/2, bxHeight/2 + gap)
                    .L(bxWidth/2, bxHeight/2 + 3*gap)
                    .A(2*gap, 3*gap, 0, 0, 0, bxWidth/2, bxHeight/2 - 3*gap)
                    .L(bxWidth/2, bxHeight/2 - gap)
                    .L(wGapMul*gap, bxHeight/2 - gap)
                    .L(wGapMul*gap, hGapMul*gap + gap)
            ...
            t = Leo.path(
                Leo.pathBuild
                    ...
                    .L(wGapMul*gap/2, hGapMul*gap + wGapMul*gap/2)
                    .A(wGapMul*gap/2, wGapMul*gap/2, 0, 0, 1, gap, hGapMul*gap)
                    .Z()
