...
~9KB
*/
!function(t){function e(t,e,r){this.namespaces=p;var n,i,s=this;r=r||{},this.tag=o("svg"),this.tag.setAttribute("width",t),this.tag.setAttribute("height",e),this.tag.setAttribute("xmlns",p.svg),
...
"ns"in r)for("*"===r.ns&&(r.ns=Object.keys(p)),n=0,i=r.ns.length;n<i;n++)!function(t){t in p&&s.tag.setAttribute("xmlns:"+t,p[t])}(r.ns[n])}function r(){this.path="",this.previous=null}function n(t){
...
return t.attrs({transform:t.transforms.rotate+" "+t.transforms.move+" "+t.transforms.scale}),t}var p={cc:"http://creativecommons.org/ns#",dc:"http://purl.org/dc/elements/1.1/",
...
"string"==typeof t&&(t=e.toDocument(t));var r=new e(1,1);return r.tag=t.children[0],r},e.getqs=function(){var t,e,r=document.location.search.substr(1),n=r.split("&"),o={};for(t in n)e=n[t].split("="),
...
return(new DOMParser).parseFromString(t,"image/svg+xml")},e.prototype.attrs=function(t){var e;if("string"==typeof t)return this.tag.getAttribute(t);for(e in t)this.tag.setAttribute(e,t[e]);return this
},e.prototype.styles=function(t){var e;for(e in t)this.tag.style[e]=t[e];return this},e.prototype.add=function(){var t=this;return[].slice.call(arguments,0).forEach(function(e){
e instanceof Array?e.forEach(function(e){t.childs.push(e),t.add(e)}):(t.childs.push(e),t.tag.appendChild(e.tag))}),this},e.prototype.render=function(t){var e=t&&"target"in t?t.target:this.target
...
var i=new s("image");return i.attrs({x:t,y:e,width:r,height:n}),i.tag.setAttributeNS(p.xlink,"xlink:href",o),i},e.prototype.line=function(t,e,r,n){var o=new s("line");return o.attrs({x1:t,y1:e,x2:r,
y2:n}),o},e.prototype.path=function(t){var e=new s("path");return e.attrs({d:t}),e},e.prototype.polygon=function(){var t=new s("polygon"),e=[].slice.call(arguments,0),r=[],n=0,o=e.length
;for(null;n<o;n+=2)r.push(e[n]+","+e[n+1]);return t.attrs({points:r.join(" ")}),t},e.prototype.polyline=function(){var t=new s("polyline"),e=[].slice.call(arguments,0),r=[],n=0,o=e.length
;for(null;n<o;n+=2)r.push(e[n]+","+e[n+1]);return t.attrs({points:r.join(" ")}),t},e.prototype.rect=function(t,e,r,n){n=n||r;var o=new s("rect");return o.attrs({x:t,y:e,width:r,height:n}),o},
e.prototype.text=function(t,e,r){var n=new s("text");return n.attrs({x:t,y:e}),n.tag.innerHTML=r,n},e.prototype.textPath=function(t,e,r){
var n=this,o=new s("text"),i=new s("defs"),a=n.path(e),u=new s("textPath");return a.attrs({id:t}),u.tag.innerHTML=r,u.tag.setAttributeNS(p.xlink,"xlink:href","#"+t),o.add(i),o.add(u),i.add(a),o},
e.prototype.title=function(t){var e=new s("title");return e.tag.innerHTML=t,e},e.prototype.script=function(t){var e=new s("script");return e.attrs({type:"application/ecmascript"}),
t&&(e.tag.innerHTML="//<![CDATA[\n"+t+"\n]]>"),e},e.prototype.textBox=function(t,e,r,n){var o=new s("svg"),i=new s("rect"),a=new s("text");return i.attrs({x:0,y:0,width:e,height:r,"stroke-width":0,
stroke:"transparent"}),o.attrs({width:e,height:r}),a.attrs({x:"50%",y:"50%","dominant-baseline":"middle","text-anchor":"middle"}),n&&a.attrs(n),a.tag.innerHTML=t,o.add(i,a),o},r.prototype.M=n("M"),
...
var i=this,s=i.slicePath(t,e,r,n,o);return i.path(s)},e.prototype.slicePath=function(t,e,r,n,o){var s=this,a=0;if(n>o){var p=n;n=o,o=p}return a=o-n<=180?0:1,n=i(n),o=i(o),
s.pathBuild.M(t,e).L(t+Math.cos(n)*r,e-Math.sin(n)*r).A(r,r,0,a,0,t+Math.cos(o)*r,e-Math.sin(o)*r).L(t,e)};var u=0;e.prototype.filters=function(){function t(){return"leo_id_"+ ++u}function e(e){
