...
;return["M",t,e,"L",i.x,i.y,"A",n,n,0,p,0,s.x,s.y,"Z"].join(" ")}function u(t,e){this.t=t,this.tag=o(t,e),this.childs=[],this.events={},this.transforms={rotate:"",move:"",scale:""}}function h(t){
...
var e=this.tag,n=e.getBoundingClientRect(),r=n.left,o=n.top,i=this.width,s=this.height,a=function(t,e){return parseFloat(t.toFixed(e||2),10)};return e.addEventListener("mousemove",function(t){
var e=t.clientX,n=t.clientY,p=100*(e-r)/i,u=100*(n-o)/s;console.log({px:a(p),py:a(u)})}),this},e.prototype.downloadHref=function(){
...
var i,a=s(this),p=l(),h=new u("linearGradient"),c={id:p,x1:e||"0%",y1:n||"0%",x2:r||"100%",y2:o||"0%"};return h.setAttributes(c),t.forEach(function(t){i=new u("stop");var e={offset:t.perc+"%",
"stop-color":t.color};"style"in t&&(e.style=t.style),i.setAttributes(e),h.append(i)}),a.append(h),"url(#"+p+")"},e.prototype.radialGradient=function(t){var e,n=(s(this),l()),r=new u("radialGradient")
...
u.prototype.rotate=function(t,e,n){return e=e||0,n=n||0,this.transforms.rotate=" rotate("+t+" "+e+" "+n+")",h(this)},u.prototype.scale=function(t,e){return t=t||0,e=e||t||0,
