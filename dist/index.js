...
o=s(o),this.pathBuild.M(t,e).L(t+Math.cos(n)*r,e-Math.sin(n)*r).A(r,r,0,i,0,t+Math.cos(o)*r,e-Math.sin(o)*r).L(t,e)};var f=function(t){return function(e){var r=new l("stop"),n={offset:e.perc+"%",
...
;var u=p(t,e,n,o),l=p(t,e,n,i),c=p(t,e,r,i),h=p(t,e,r,o);return this.path(this.pathBuild.M(h.x,h.y).L(u.x,u.y).A(n,n,0,0,s,l.x,l.y).L(c.x,c.y).A(r,r,0,0,a,h.x,h.y).Z())};var d=function(){var t=0
;return function(){return"leo_id_"+ ++t}}(),y=0;l.prototype.setAttributes=e.prototype.setAttributes,l.prototype.getAttributes=e.prototype.getAttributes,l.prototype.setStyles=e.prototype.setStyles,
l.prototype.getStyles=e.prototype.getStyles,l.prototype.append=e.prototype.append,l.prototype.remove=e.prototype.remove,l.prototype.on=function(t,e){
...
l.prototype.replace=function(t,e){t.tag.parentNode.replaceChild(e.tag,t.tag),t.parent.childs=t.parent.childs.map(function(r){return r._id==t._id?e:r})};var g=function(t,r,n){
if(!t||!r||t<0||r<0)throw new Error("width or height not given!");return new e(t,r,n)};return g.import=e.import,g.getqs=e.getqs,g.toString=e.toString,g.toDocument=e.toDocument,
