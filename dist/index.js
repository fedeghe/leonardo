...
~12.97KB
*/
const Leonardo=function(t){function e(t,e,n){this.namespaces=l;var r,i,s=this;n=n||{},this.width=t,this.height=e,this.tag=o("svg"),this.tag.setAttribute("width",t),this.tag.setAttribute("height",e),
this.tag.setAttribute("xmlns",l.svg),this.tag.setAttribute("viewbox","0 0 "+t+" "+e),this.childs=[];for(r in n)"ns"!==r&&"target"!==r&&this.tag.setAttribute(r,n[r])
;if(this.target="target"in n?n.target:null,"ns"in n)for("*"===n.ns&&(n.ns=Object.keys(l)),r=0,i=n.ns.length;r<i;r++)!function(t){t in l&&s.tag.setAttribute("xmlns:"+t,l[t])}(n.ns[r])}function n(){
...
function o(t,e){return e=e||l.svg,document.createElementNS(e,t)}function i(t){return t*Math.PI/180}function s(t){return t.defs||(t.defs=new u("defs"),t.append(t.defs)),t.defs}function a(t,e,n,r){
...
return t.setAttributes({transform:t.transforms.rotate+" "+t.transforms.move+" "+t.transforms.scale}),t}var l={cc:"http://creativecommons.org/ns#",dc:"http://purl.org/dc/elements/1.1/",
...
var e,n,r,o=this.tag,i=t?document.createElement("div"):null,s=t?document.createElement("ul"):null,a=o.getBoundingClientRect(),p=a.left,u=a.top,c=this.width,l=this.height,h=function(t,e){
return parseFloat(t.toFixed(e||2),10)},f={x:0,y:0};return i.style.fontFamily="verdana",s.style.fontFamily="verdana",s.style.listStyleType="decimal",s.style.fontSize="0.8em",
o.addEventListener("mousemove",function(o){var s=o.clientX,a=o.clientY;n=s-p,r=a-u;var g=100*n/c,d=100*r/l;e="%("+h(g)+" "+h(d)+") px ("+~~n+" "+~~r+") r % ("+h(function(t){return 100*t/c
}(~~n-f.x))+" "+h(function(t){return 100*t/l}(~~r-f.y))+") r px ("+(~~n-f.x)+" "+(~~r-f.y)+")",t?(i.style.left=s+"px",i.style.top=a+"px",i.innerHTML=e):console.log(e)}),
...
var i=new u("image");return i.setAttributes({x:t,y:e,width:n,height:r}),i.tag.setAttributeNS(l.xlink,"xlink:href",o),i},e.prototype.line=function(t,e,n,r){var o=new u("line");return o.setAttributes({
...
var i,a=s(this),p=h(),c=new u("linearGradient"),l={id:p,x1:e||"0%",y1:n||"0%",x2:r||"100%",y2:o||"0%"};return c.setAttributes(l),t.forEach(function(t){i=new u("stop");var e={offset:t.perc+"%",
"stop-color":t.color};"style"in t&&(e.style=t.style),i.setAttributes(e),c.append(i)}),a.append(c),"url(#"+p+")"},e.prototype.radialGradient=function(t){var e,n=(s(this),h()),r=new u("radialGradient")
...
a.tag.setAttributeNS(l.xlink,"xlink:href","#"+t),o.append(i),o.append(a),i.append(s),o},e.prototype.centeredText=function(t,e,n,r){
