...
t.tag.appendChild(e.tag))}),this},e.prototype.render=function(t){var e=t.target||this.target;if(!e)throw"Target not set";return e.innerHTML="",e.appendChild(this.tag),t.cb&&t.cb.call(this),this},
e.prototype.downloadAnchor=function(t,e){var r=new XMLSerializer,n='<?xml version="1.0" standalone="no"?>\r\n'+r.serializeToString(this.tag),o=null;t=t||"download",e=e||"download",
