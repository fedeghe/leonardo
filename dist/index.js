...
;return n.style.fontFamily=o.style.fontFamily="verdana",o.style.listStyleType="decimal",o.style.fontSize="0.8em",window.addEventListener("scroll",g),r.addEventListener("mousemove",function(e){
var r=e.clientX+f.left,o=e.clientY+f.top;d.x=r-s,d.y=o-a,c=t;var i=100*d.x/p,g=100*d.y/u,y={"%x":l(i),"%y":l(g),"r%x":l(function(t){return 100*t/p}(~~d.x-h.x)),"r%y":l(function(t){return 100*t/u
}(~~d.y-h.y)),x:~~d.x,y:~~d.y,rx:~~d.x-h.x,ry:~~d.y-h.y};for(var v in y)c=c.replace("{"+v+"}",y[v]);n.innerHTML=c}),r.parentNode.appendChild(n),r.parentNode.appendChild(o),
...
this.pathBuild.M(t,e).L(t+Math.cos(n)*r,e-Math.sin(n)*r).A(r,r,0,i,0,t+Math.cos(o)*r,e-Math.sin(o)*r).L(t,e)};var f=function(t){return function(e){var r=new l("stop"),n={offset:e.perc+"%",
"stop-color":e.color};"style"in e&&(n.style=e.style),r.setAttributes(n),t.append(r)}};e.prototype.linearGradient=function(t,e,r,n,o){var i=a(this),s=d(),p=new l("linearGradient"),u={id:s,x1:e||"0%",
y1:r||"0%",x2:n||"100%",y2:o||"0%"},c=f(p);return p.setAttributes(u),t.forEach(c),i.append(p),"url(#"+s+")"},e.prototype.radialGradient=function(t){var e=a(this),r=d(),n=new l("radialGradient"),o=f(n)
;return n.setAttributes({id:r}),t.forEach(o),e.append(n),"url(#"+r+")"},e.prototype.filter=function(t){a(this)
;var e=d(),r=new l("filter"),n=["feGaussianBlur","feDropShadow","feMorphology","feDisplacementMap","feBlend","feColorMatrix","feConvolveMatrix","feComponentTransfer","feSpecularLighting","feDiffuseLighting","feFlood","feTurbulence","feImage","feTile","feOffset","feComposite","feMerge"]
...
;return e.setAttributes({attributeName:t.attributeName,values:t.values,dur:t.dur,begin:t.begin||"0s",repeatCount:t.repeatCount}),e}return{cartesian:t,polar:e,attr:r}}(),
...
var o=this.group(),i=d(),s=new l("path"),a=new l("text"),p=new l("textPath");return s.setAttributes({id:i,pathLength:t,d:"M0 "+e/2+"h"+t,height:0,"stroke-opacity":0}),n=n||{},n.href="#"+i,
...
e.prototype.arcCentered=function(t,e,r,n,o){var i=new l("path");return i.setAttributes({d:u(t,e,r,n,o)}),i};var d=function(){var t=0;return function(){return"leo_id_"+ ++t}}(),g=0
...
this.tag.addEventListener(t,e),this},l.prototype.off=function(t,e){var r=this;return t in this.events&&(void 0===e?(this.events[t].forEach(function(e){r.tag.removeEventListener(t,e)}),
this.events[t]=null):r.tag.removeEventListener(t,e)),this},l.prototype.once=function(t,e){var r=this;return this.on(t,function n(o){r.off(t,n),e(o)}),this},l.prototype.trigger=function(t){
var e=this.tag;e.dispatchEvent(new Event(t,{target:e}))},l.prototype.clone=function(){var t,e=new l(this.t),r=this.tag.attributes,n=0;for(e.transforms.rotate=this.transforms.rotate,
e.transforms.move=this.transforms.move,e.transforms.scale=this.transforms.scale,n=0,t=r.length;n<t;n++)e.tag.setAttribute(r[n].name,r[n].value);for(n=0,
t=this.childs.length;n<t;n++)e.append(this.childs[n].clone());return 0==t&&(e.tag.innerHTML=this.tag.innerHTML),e},l.prototype.use=function(){var t=this.tag.attributes.id,e=new l("use")
...
if(!t||!r||t<0||r<0)throw new Error("width or height not given!");return new e(t,r,n)};return y.import=e.import,y.getqs=e.getqs,y.toString=e.toString,y.toDocument=e.toDocument,
y.randomColor=e.randomColor,y}();"object"==typeof exports&&(module.exports=Leonardo);