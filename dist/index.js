...
;return i.path(s)},e.prototype.slicePath=function(t,e,r,n,o){var i=0;if(n>o){var s=n;n=o,o=s}return i=o-n<=180?0:1,n=a(n),o=a(o),
this.pathBuild.M(t,e).L(t+Math.cos(n)*r,e-Math.sin(n)*r).A(r,r,0,i,0,t+Math.cos(o)*r,e-Math.sin(o)*r).L(t,e)};var h=0;e.prototype.linearGradient=function(t,e){var r,n,s=(i(this),
...
"stop-color":t[r]}),a.append(n);return this.defs.append(a),"url(#"+s+")"},e.prototype.radialGradient=function(t){var e,r,n=(i(this),o()),s=new p("radialGradient");s.setAttributes({id:n})
;for(e in t)r=new p("stop"),r.setAttributes({offset:e+"%","stop-color":t[e]}),s.append(r);return this.defs.append(s),"url(#"+n+")"},e.prototype.animate=function(){function t(t,e,r,n){n=n||20
;var o=0,i=0,s=0,a=setInterval(function(){i=e(i,o),s=r(s,o),o+=.1,t.move(i,s)},n);return function(){clearInterval(a)}}function e(t,e,r,n){n=n||20;var o=0,i=0,s=0,a=setInterval(function(){i=e(i,o),
s=r(s,o),o+=.1,t.move(i*Math.cos(s),i*Math.sin(s))},n);return function(){clearInterval(a)}}function r(t){var e=new p("animate");return e.setAttributes({attributeType:"XML",
attributeName:t.attributeName,from:t.from,to:t.to,dur:t.dur,repeatCount:t.repeatCount}),e}return{cartesian:t,polar:e,attr:r}}(),p.prototype.setAttributes=e.prototype.setAttributes,
...
this.tag.addEventListener(t,e),this},p.prototype.off=function(t,e){var r=this;return t in this.events&&(void 0===e?(this.events[t].forEach(function(e){r.tag.removeEventListener(t,e)}),
this.events[t]=null):r.tag.removeEventListener(t,e)),this},p.prototype.once=function(t,e){var r=this;return t in this.events?this.events[t].push(e):this.events[t]=[e],
this.tag.addEventListener(t,function n(o){e(o),r.off(t,n)}),this},p.prototype.clone=function(){var t,e=new p(this.t),r=this.tag.attributes,n=0;for(e.transforms.rotate=this.transforms.rotate,
...
t=this.childs.length;n<t;n++)e.append(this.childs[n].clone());return 0==t&&(e.tag.innerHTML=this.tag.innerHTML),e},p.prototype.use=function(){var t=this.tag.attributes.id,e=new p("use")
;if(!t)throw new Error("You can use use only on tags having an id attribute");return e.tag.setAttribute("href","#"+t.value),e},p.prototype.rotate=function(t,e,r){return e=e||0,r=r||0,
this.transforms.rotate=" rotate("+t+" "+e+" "+r+")",u(this)},p.prototype.scale=function(t,e){return t=t||0,e=e||0,this.transforms.scale=" scale("+t+", "+e+")",u(this)},p.prototype.mirrorH=function(){
...
p.prototype.replace=function(t,e){t.tag.parentNode.replaceChild(e.tag,t.tag)},p.prototype.getBbox=function(){return this.tag.getBBox()};var l=function(t,r,n){return t&&r?new e(t,r,n):{
