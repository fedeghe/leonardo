...
var i=new p("image");return i.setAttributes({x:t,y:e,width:n,height:r}),i.tag.setAttributeNS(h.xlink,"xlink:href",o),i},e.prototype.line=function(t,e,n,r){var o=new p("line");return o.setAttributes({
...
a.tag.setAttributeNS(h.xlink,"xlink:href","#"+t),o.append(i),o.append(a),i.append(s),o},e.prototype.title=function(t){var e=new p("title");return e.tag.innerHTML=t,e},e.prototype.script=function(t){
...
;return i.path(s)},e.prototype.slicePath=function(t,e,n,r,o){var i=this,s=0;if(r>o){var p=r;r=o,o=p}return s=o-r<=180?0:1,r=a(r),o=a(o),
i.pathBuild.M(t,e).L(t+Math.cos(r)*n,e-Math.sin(r)*n).A(n,n,0,s,0,t+Math.cos(o)*n,e-Math.sin(o)*n).L(t,e)};var c=0;e.prototype.linearGradient=function(t,e){var n,r,s=(i(this),
...
i=n(i,r),r+=.1,t.move(o*Math.cos(i),o*Math.sin(i))},20)}function n(t,e,n,r,o){var i=new p("animate");return i.setAttributes({attributeType:"XML",attributeName:t,from:e,to:n,dur:r,repeatCount:o}),i}
return{pCart:t,pPolar:e,attr:n}}(),p.prototype.setAttributes=e.prototype.setAttributes,p.prototype.styles=e.prototype.styles,p.prototype.append=e.prototype.append,p.prototype.on=function(t,e){
