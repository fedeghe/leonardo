...
var e,n=this.tag,r=t?document.createElement("div"):null,o=t?document.createElement("ul"):null,i=n.getBoundingClientRect(),s=i.left,a=i.top,p=this.width,u=this.height,c=function(t,e){
return parseFloat(t.toFixed(e||2),10)},h={x:0,y:0},l={x:0,y:0};return r.style.fontFamily="verdana",o.style.fontFamily="verdana",o.style.listStyleType="decimal",o.style.fontSize="0.8em",
n.addEventListener("mousemove",function(n){var o=n.clientX,i=n.clientY;l.x=o-s,l.y=i-a;var f=100*l.x/p,g=100*l.y/u;e="%("+c(f)+" "+c(g)+") px("+~~l.x+" "+~~l.y+") R%("+c(function(t){return 100*t/p
}(~~l.x-h.x))+" "+c(function(t){return 100*t/u}(~~l.y-h.y))+") Rpx("+(~~l.x-h.x)+" "+(~~l.y-h.y)+")",t?r.innerHTML=e:console.log(e)}),t&&(n.parentNode.appendChild(r),n.parentNode.appendChild(o),
n.addEventListener("click",function(){var t=document.createElement("li");h={x:~~l.x,y:~~l.y},t.innerHTML=e,o.appendChild(t)})),this},e.prototype.downloadHref=function(){
