...
e.appendChild(this.tag),t&&(t.cb&&t.cb.call(this),t.fade&&this.fadeIn(parseInt(t.fade,10))),this},e.prototype.fadeIn=function(t){function e(o){var i=(o-r)/t;n.tag.style.opacity=i,
...
cartesian:t,polar:e,attr:r}}(),e.prototype.textPath=function(t,e,r){var n=this,o=new a("text"),i=new a("defs"),s=n.path(e),p=new a("textPath");return s.setAttributes({id:t}),p.tag.innerHTML=r,
p.tag.setAttributeNS(u.xlink,"xlink:href","#"+t),o.append(i),o.append(p),i.append(s),o},e.prototype.centeredText=function(t,e,r,n){
var o=this.group(),i=h(),s=new a("path"),p=new a("text"),u=new a("textPath");return s.setAttributes({id:i,pathLength:t,d:"M0 "+e/2+"h"+t,height:0,"stroke-opacity":0}),n=n||{},n.href="#"+i,
n["text-anchor"]="middle",n["dominant-baseline"]="middle",n.startOffset=t/4,u.setAttributes(n),u.tag.innerHTML=r,p.append(u),o.append(s,p),o.updateText=function(t){u.tag.innerHTML=t},o}
;var h=function(){var t=0;return function(){return"leo_id_"+ ++t}}();a.prototype.setAttributes=e.prototype.setAttributes,a.prototype.styles=e.prototype.styles,a.prototype.append=e.prototype.append,
