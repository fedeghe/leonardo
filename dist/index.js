...
var o=this.group(),i=h(),s=new a("path"),p=new a("text"),u=new a("textPath");return s.setAttributes({id:i,pathLength:t/2,d:"M0 "+e/2+"h"+t}),n=n||{},n.href="#"+i,n["text-anchor"]="middle",
n["dominant-baseline"]="middle",n.startOffset=t/4,u.setAttributes(n),u.tag.innerHTML=r,p.append(u),o.append(s,p),o.updateText=function(t){u.tag.innerHTML=t},o};var h=function(){var t=0
;return function(){return"leo_id_"+ ++t}}();a.prototype.setAttributes=e.prototype.setAttributes,a.prototype.styles=e.prototype.styles,a.prototype.append=e.prototype.append,
