...
return parseFloat(t.toFixed(e||2),10)},c={x:0,y:0},h={x:0,y:0},f=[];return r.style.fontFamily="verdana",o.style.fontFamily="verdana",o.style.listStyleType="decimal",o.style.fontSize="0.8em",
...
n.addEventListener("click",function(){var n=document.createElement("li"),r=e.circle(1+~~h.x,1+~~h.y,2);r.setAttributes({stroke:"white","stroke-width":1}),r.on("mouseover",function(){
n.style.fontWeight="bold",r.setAttributes({fill:"red",r:4})}),r.on("mouseleave",function(){n.style.fontWeight="normal",r.setAttributes({fill:"",r:2})}),f.push({item:n,dot:r}),c={x:~~h.x,y:~~h.y},
n.innerHTML=t,n.addEventListener("mouseover",function(){n.style.fontWeight="bold",r.setAttributes({fill:"red",r:4})}),n.addEventListener("mouseout",function(){n.style.fontWeight="normal",
r.setAttributes({fill:"",r:2})}),o.appendChild(n),e.append(r)}),this},e.prototype.downloadHref=function(){
...
u.prototype.rotate=function(t,e,n){return e=e||0,n=n||0,this.transforms.rotate=" rotate("+t+" "+e+" "+n+")",l(this)},u.prototype.scale=function(t,e){return t=t||0,e=e||t||0,
this.transforms.scale=" scale("+t+", "+e+")",l(this)},u.prototype.mirrorH=function(){return this.transforms.scale=" scale(1, -1)",l(this)},u.prototype.mirrorV=function(){
return this.transforms.scale=" scale(-1, 1)",l(this)},u.prototype.move=function(t,e){return t=t||0,e=e||0,this.transforms.move=" translate("+t+" "+e+")",l(this)},u.prototype.remove=function(){
