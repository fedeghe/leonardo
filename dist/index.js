...
;return["M",t,e,"L",i.x,i.y,"A",r,r,0,a,0,s.x,s.y,"Z"].join(" ")}function l(t,e){this.t=t,this.tag=i(t,e),this.childs=[],this.events={},this.transforms={rotate:"",move:"",scale:""}}function c(t){
...
t.append(e)}):(t.childs.push(e),t.tag.appendChild(e.tag))}),this},e.prototype.render=function(t){var e=t&&"target"in t?t.target:this.target;if(!e)throw new Error("Target not set")
...
r.innerHTML=t,r},e.prototype.positionInspector=function(t){t=t||"%({Px} {Py})  R%({RPx} {RPy})  PX({x} {y}) RPX({rx} {ry})"
...
r.addEventListener("mousemove",function(e){var r=e.clientX,o=e.clientY;f.x=r-s,f.y=o-a,c=t;var i=100*f.x/p,g=100*f.y/u,y={Px:l(i),Py:l(g),RPx:l(function(t){return 100*t/p}(~~f.x-h.x)),
RPy:l(function(t){return 100*t/u}(~~f.y-h.y)),x:~~f.x,y:~~f.y,rx:~~f.x-h.x,ry:~~f.y-h.y};for(var d in y)c=c.replace("{"+d+"}",y[d]);n.innerHTML=c}),r.parentNode.appendChild(n),
...
t.style.fontWeight="normal",r.setAttributes({fill:"white",r:2})}),o.appendChild(t),e.append(r)}),this},e.prototype.downloadHref=function(){
...
e.prototype.arcCentered=function(t,e,r,n,o){var i=new l("path");return i.setAttributes({d:u(t,e,r,n,o)}),i};var f=function(){var t=0;return function(){return"leo_id_"+ ++t}}()
...
l.prototype.bringToTop=function(){this.bringTo(1/0)},l.prototype.bringToBottom=function(){this.bringTo(-1/0)},l.prototype.timeout=function(t,e){var r=t.bind(this);return setTimeout(r,e),this},
...
for(;t--<0&&r.previousSibling;)r=r.previousSibling;e.removeChild(this.tag),e.insertBefore(this.tag,r)}}},l.prototype.bringToTop=function(){var t=this.tag.ownerSVGElement;t.removeChild(this.tag),
...
return this.tag.getBBox()};var g=function(t,r,n){if(!t||!r||t<0||r<0)throw new Error("width or height not given!");return new e(t,r,n)};return g.import=e.import,g.getqs=e.getqs,g.toString=e.toString,
g.toDocument=e.toDocument,g}();"object"==typeof exports&&(module.exports=Leonardo);